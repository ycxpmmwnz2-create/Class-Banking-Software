...
- Use Codex implementation, Muse Spark detailed checking, and Claude final
  independent 100-foot review under `AI_COLLABORATION_WORKFLOW.md` and
  `GROK_REVIEW_HANDOFF.md` for material cleanup.
